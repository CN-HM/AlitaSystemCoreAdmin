<template>
  <v-card>
    ...
    <v-row class="ma-0 pb-5 px-2">
      ...
      <v-col cols="9" sm="10">
        <p class="subtitle-1 text-truncate mb-0">Cupcake ipsum dolor sit amet fruitcake donut chocolate.</p>
      ...
      <v-col cols="9" sm="10">
        <p class="subtitle-2 mb-0">Cupcake ipsum dolor sit amet fruitcake donut chocolate.</p>
      ...
      <v-col cols="9" sm="10">
        <p class="body-1 mb-0">Cupcake ipsum dolor sit amet fruitcake donut chocolate.</p>
      ...
      <v-col cols="9" sm="10">
        <p class="body-2 mb-0">Cupcake ipsum dolor sit amet fruitcake donut chocolate.</p>
